package com.biswa.springopenid.config;
...
import com.biswa.springopenid.domain.OpenIdConnectUserDetails;
	...
	public Authentication attemptAuthentication(HttpServletRequest request,
		...
		try {
		 accessToken = restTemplate.getAccessToken();
			...
			throw new BadCredentialsException("Could not obtain access token", oe);
		}
